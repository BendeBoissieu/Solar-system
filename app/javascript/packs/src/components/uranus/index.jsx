...
export function Uranus(props) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      uranusRef.current.position.x = 850 * COEFFICIENT_SCALE_AFTER_EARTH * Math.cos(uranusRef.current.rotation.y)
      uranusRef.current.position.z = 850 * COEFFICIENT_SCALE_AFTER_EARTH * Math.sin(uranusRef.current.rotation.y)
    }, 10);
  ...
  return (
    <>
      <mesh onClick={() => props.handleClick("uranus")}
            ...
            ref={uranusRef} position={[850 * COEFFICIENT_SCALE_AFTER_EARTH,0,850 * COEFFICIENT_SCALE_AFTER_EARTH]}>
